...
echo ""
echo "════════════════════════════════════════════════"
echo -e "  ${CYAN}🗄️  数据库迁移工具（标准版本）${NC}"
echo "════════════════════════════════════════════════"
echo ""
echo -e "${CYAN}[INFO]${NC} Running migrations for CockroachDB..."
echo -e "${CYAN}[INFO]${NC} Database URL: $DATABASE_URL"
echo -e "${CYAN}[INFO]${NC} Using standardized migration files"
echo ""
...
if sqlx migrate run --database-url "$DATABASE_URL"; then
    ...
    echo ""
    echo -e "${CYAN}[INFO]${NC} Standardized migration files executed:"
